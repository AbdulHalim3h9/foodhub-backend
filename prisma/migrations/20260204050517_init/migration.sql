...
-- AddForeignKey
ALTER TABLE "categories" ADD CONSTRAINT "categories_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "provider_profiles"("id") ON DELETE CASCADE ON UPDATE CASCADE;
