...
router.get("/all", (req, res, next) => {
    ...
    next();
}, auth(UserRole.ADMIN, UserRole.PROVIDER), orderController.getAllOrders);
router.get("/:orderId", auth(UserRole.CUSTOMER), orderController.getOrderById);
router.patch("/:orderId/status", auth(UserRole.ADMIN, UserRole.PROVIDER), orderController.updateOrderStatus);
