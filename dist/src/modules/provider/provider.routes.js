...
router.post("/menu", auth(UserRole.PROVIDER), providerController.createMenuItem);
router.put("/menu/:mealId", auth(UserRole.PROVIDER), providerController.updateMenuItem);
router.delete("/menu/:mealId", auth(UserRole.PROVIDER), providerController.deleteMenuItem);
