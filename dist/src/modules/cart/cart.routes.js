...
router.put("/items/:mealId", auth(UserRole.CUSTOMER), cartController.updateItemQuantity);
router.delete("/items/:mealId", auth(UserRole.CUSTOMER), cartController.removeItemFromCart);
